...
/* MMIO status bits */
#define MMIO_STATUS_EVT_OVERFLOW		0
#define MMIO_STATUS_EVT_OVERFLOW_MASK		BIT(0)
#define MMIO_STATUS_EVT_INT			1
#define MMIO_STATUS_EVT_INT_MASK		BIT(1)
#define MMIO_STATUS_COM_WAIT_INT		2
#define MMIO_STATUS_COM_WAIT_INT_MASK		BIT(2)
#define MMIO_STATUS_EVT_RUN			3
#define MMIO_STATUS_EVT_RUN_MASK		BIT(3)
#define MMIO_STATUS_CMDBUF_RUN			4
#define MMIO_STATUS_CMDBUF_RUN_MASK		BIT(4)
#define MMIO_STATUS_PPR_OVERFLOW		5
#define MMIO_STATUS_PPR_OVERFLOW_MASK		BIT(5)
#define MMIO_STATUS_PPR_INT			6
#define MMIO_STATUS_PPR_INT_MASK		BIT(6)
#define MMIO_STATUS_PPR_RUN			7
