 ...
 * NOTE: IOMMU is enforced by SNP to ensure that hypervisor cannot program
 * DMA directly into guest private memory. In case of SNP, the IOMMU ensures
 * that the page(s) used for DMA are hypervisor owned.
 */
